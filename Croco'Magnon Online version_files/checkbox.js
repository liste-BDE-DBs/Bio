...
// var socialBackground = document.getElementById("glass-btn");

var socialBackground = $(".glass-btn");

// ___________________________________________________________________

function turnDark() {
    console.log("\x1b[32m---------- [CONSOLE CMG] ----------\n      \x1b[30mPassage en mode nuit");
    generalBackground.style.backgroundColor = '#320065';
    ...
    socialBackground.css("background-color", "#27034a");
...
function turnLight() {
    ...
    socialBackground.css("background-color", "#fafafa");
